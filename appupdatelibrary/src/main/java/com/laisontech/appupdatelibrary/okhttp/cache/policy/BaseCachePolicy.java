package com.laisontech.appupdatelibrary.okhttp.cache.policy;
...
import com.laisontech.appupdatelibrary.okhttp.db.CacheManager;
...
import com.laisontech.appupdatelibrary.okhttp.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        OkHttpServerUtils.getInstance().getDelivery().post(run);
    }
