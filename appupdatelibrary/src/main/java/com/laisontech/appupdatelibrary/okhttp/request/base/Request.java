package com.laisontech.appupdatelibrary.okhttp.request.base;

import android.text.TextUtils;

import com.laisontech.appupdatelibrary.okhttp.OkHttpServerUtils;
import com.laisontech.appupdatelibrary.okhttp.adapter.AdapterParam;
import com.laisontech.appupdatelibrary.okhttp.adapter.CacheCall;
import com.laisontech.appupdatelibrary.okhttp.adapter.Call;
import com.laisontech.appupdatelibrary.okhttp.adapter.CallAdapter;
...
import com.laisontech.appupdatelibrary.okhttp.cache.policy.CachePolicy;
import com.laisontech.appupdatelibrary.okhttp.callback.Callback;
import com.laisontech.appupdatelibrary.okhttp.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        this.url = url;
        baseUrl = url;
        OkHttpServerUtils go = OkHttpServerUtils.getInstance();
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkHttpServerUtils.getInstance().getOkHttpClient();
